        ...
        <div className="relative">
          ...
          <div className="bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-3xl p-8 shadow-2xl shadow-primary/10">
            ...
            <div className="text-center mb-8">
              ...
              <Link
                href="/auth/register"
                className="bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-white font-semibold py-4 px-8 rounded-2xl text-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center gap-2 w-fit mx-auto"
              >
