...
import SubredditSelector from "@/components/onboarding/SubredditSelector";
    ...
    <main className="relative max-h-screen bg-gradient-to-br from-white to-zinc-200">
      ...
      {step === 0 ? (
        ...
        <div className="flex justify-center items-center min-h-screen">
          ...
          >
            <Card className="w-full max-w-6xl shadow-xl overflow-hidden py-0 h-[80vh]">
              <div className="flex h-[80vh]">
                <div className="w-80 flex-shrink-0">
                  <OnboardingProgress />
                </div>

                <div className="flex-1 bg-white overflow-y-auto relative w-[60vw]">
                  <AnimatePresence mode="wait" custom={direction}>
                    <motion.div
                      key={step}
                      custom={direction}
