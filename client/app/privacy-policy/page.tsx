            ...
            <div className="space-y-8">
              <section>
                ...
                <p className="text-foreground leading-relaxed">
                  ...
                  Reddit CRM platform and related services.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-foreground leading-relaxed mb-4">
                  ...
                  may share information in these limited circumstances:
                </p>
              ...
              <section>
                ...
                <p className="text-foreground leading-relaxed mb-4">
                  ...
                  our services and fulfill the purposes described in this
                  policy. Specifically:
                </p>
                <ul className="list-disc pl-6 space-y-2 text-foreground">
                  ...
                  <li>
                    Usage analytics: Aggregated data may be retained
                    indefinitely
                  </li>
                  <li>
              ...
              <section>
                ...
                <p className="text-foreground leading-relaxed mb-4">
                  ...
                  cookies through your browser settings, though some features
              ...
              <section>
                ...
                <p className="text-foreground leading-relaxed">
                  ...
                  place to protect your data in accordance with this Privacy
              ...
              <section>
                ...
                <p className="text-foreground leading-relaxed">
                  Reddinbox is not intended for use by individuals under 13
                  years of age. We do not knowingly collect personal information
                  from children under 13. If we become aware of such data
              ...
              <section>
                ...
                <p className="text-foreground leading-relaxed">
                  ...
                  The &quot;Last updated&quot; date indicates when the policy
                  was last modified.
                </p>
              </section>
