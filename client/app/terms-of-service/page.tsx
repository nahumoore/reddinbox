          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <p className="text-foreground leading-relaxed mb-4">
                ...
                designed specifically for Reddit marketing and lead generation.
                Our service provides tools for managing Reddit communications,
                tracking leads, and analyzing engagement metrics.
              </p>
              <p className="text-foreground leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-3">
                ...
                <ul className="list-disc pl-6 space-y-2 text-foreground">
                  ...
                  <li>
                    Respect other users&apos; privacy and not engage in spam or
                    harassment
                  </li>
            ...
            <section>
              ...
              <p className="text-foreground leading-relaxed mb-4">
                ...
                services. This integration is subject to Reddit&apos;s API Terms
                of Use. Users must maintain valid Reddit accounts and comply
                with all Reddit policies.
              </p>
              <p className="text-foreground leading-relaxed">
                We are not affiliated with Reddit, Inc. Reddit is a trademark of
                Reddit, Inc.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-foreground leading-relaxed">
                ...
                activities that harm our service or other users. You may also
